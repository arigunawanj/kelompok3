...
<div class="container text-center">
    <div class="row justify-content-start">
        ...
        <div class="card">
            ...
            <?php
                header("refresh:2;url=data_peminjaman.php");
            }
            ?>
            <form action="" method="post">
                <div class="mb-2 row p-2">
                    <label class="col-1 form-label">ID</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="id" value="<?php echo $randomNumber ?>" disabled>
                    </div>

                    <label class="col-1 form-label">ID book</label>
                    <div class="col-sm-3">
                        <table>
                            <thead>
                                <tr>
                    ...
                    <label class="col-1 form-label">Petugas</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="officer" value="<?php echo "jhon" ?>" disabled>
                    </div>
                </div>
                <div class="mb-2 row p-2">
                    <label class="col-1 form-label">Nis</label>
                    <div class="col-sm-3">
                    ...
                    <label class="col-1 form-label">Loan Date</label>
                    <div class="col-sm-3">
                        <input type="date" class="form-control" name="loan_date" value="">
                    </div>
                    <label class="col-1 form-label">Return Date</label>
                    <div class="col-sm-3">
                ...
                <table class="table">
                    ...
                    ?>
                        <tr>
                            ...
                            <td scope="row"><?php echo $r3['author'] ?></td>
                            <td scope="row"><?php echo $r3['title'] ?></td>
                            <td scope="row"><?php echo $r3['publiser'] ?></td>
                            <td scope="row">
                                <a href="data_peminjaman.php?op=delete&id=<?php echo $id ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                    ...
                    <table class="table">
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="home.php?page=data-peminjaman?op=loan&id=<?php echo $id_book ?>"><button type="button" class="btn btn-success">Pinjam</button></a>
                                    <!-- <a href="index.php?op=delete&id=<?php echo $id ?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger">Delete</button></a> -->
                                </td>
                            </tr>
                        <?php
